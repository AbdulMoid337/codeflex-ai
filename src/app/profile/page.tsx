    ...
    <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
      {isUserLoading ? (
        ...
        <>
          ...
          {isPlansLoading ? (
            <div className="relative backdrop-blur-sm border border-border p-6 flex flex-col items-center justify-center min-h-[300px]">
              <CornerElements />
              <Loader size="md" variant="primary" className="mb-4" />
              <p className="text-muted-foreground text-sm">Loading your fitness plans...</p>
            </div>
